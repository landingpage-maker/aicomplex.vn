        ...
        <div class="flex-1 flex items-center justify-center p-4 md:p-8">
          <div class="text-center max-w-2xl">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center px-4">
              <button onclick="window.open('https://ai.studio/apps/drive/1dgX3IbTupLzVCGsREXwW-izwjDbTguJ0', '_blank')" class="bg-red-600 text-white px-4 md:px-6 py-3 md:py-4 rounded-lg text-sm md:text-base font-semibold hover:bg-red-700 transition-colors">
                Bấm để tạo ảnh
              </button>
